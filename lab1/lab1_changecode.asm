...
;;Inargument: Vald tangent i r4
;;Utargument: Inga
;;Funktion: Aktiverar larmet direkt om man klickar på A/B/C/D/E/F,
;;          annars sätter den värdet i 7-4 till nya koden
addkeynewcode:
    

    mov r3, #(0x20001007 & 0xffff)
    movt r3, #(0x20001007 >> 16)
...
;;Inargument: Inga
;;Utargument: Returnerar 1 i r4 om koden var korrekt, annars 0
;;Funktion: Kollar om nya koden matchar
checknewcode:
