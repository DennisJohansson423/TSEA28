...
main:
    ...
    ; Nollställer poäng
	mov r4, #(0x20003000 & 0xffff)
	movt r4, #(0x20003000 >> 16)
	mov r3, #0
	str r3, [r4]
	mov r4, #(0x20004000 & 0xffff)
	movt r4, #(0x20004000 >> 16)
	mov r3, #0
	str r3, [r4]
...
moveBall:
	mov r2, #(0x20002000 & 0xffff)
	movt r2, #(0x20002000 >> 16)
	ldrb r2, [r2]
	cmp r2, #0x00
	beq moveBallLeft
	bne moveBallRight
...
intgpiod:
	...
	mov r1, #(1<<7)
	str r1, [r0]
	mov r2, #(0x20001000 & 0xffff) ; Håller koll på knapptryck från höger spelare
	movt r2, #(0x20001000 >> 16)
	mov r3, #0xFF
	str r3, [r2]
...
intgpioe:
	...
	mov r1, #(1<<4)
	str r1, [r0]
	mov r2, #(0x20001000 & 0xffff) ; Håller koll på knapptryck från vänster spelare
	movt r2, #(0x20001000 >> 16)
	mov r3, #0x00
	str r3, [r2]
